   ...
   private void connectionFailed() {
    ...
    private class AcceptThread extends Thread{
        ...
        public void run(){
            if(D) {Log.d(TAG, "BEGIN mAcceptThread" + this);
                System.out.println("BEGIN mAcceptThread" + this);}
            ...
            if(D) {Log.i(TAG, "End mAcceptThread");
                System.out.println("End mAcceptThread");}
        }
        ...
        public void cancel(){
            ...
            try{
                ...
                System.out.println("close() of server failed" + this);
            }
        }
    }
    ...
    private class ConnectThread extends Thread{
        ...
        public void run(){
            ...
            System.out.println("BEGIN mConnectTread");
